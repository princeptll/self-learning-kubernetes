...
If you face an error like this while running Kubernetes commands:

<img width="1136" height="233" alt="kubectl error" src="https://github.com/user-attachments/assets/7abff038-2a93-4893-8762-cf66d8545b13" />

This usually happens due to **Docker permission issues** or running commands as `root`.

## Exit Root User

If you are logged in as root, exit first:
...
## If this fails, add user to docker group:
```bash
...
kubectl get nodes
```
<img width="552" height="107" alt="image" src="https://github.com/user-attachments/assets/2cc7af2d-947a-4f77-a190-958fb877ce3a" />
